...
class PermissionTableSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    //  Submit Absensi Kelas
    Permission::firstOrCreate(['name' => 'absenkelas.submit', 'guard_name' => 'api']);

    // Create Absensi Kelas
    Permission::firstOrCreate(['name' => 'absenkelas.create', 'guard_name' => 'api']);

    //  Delete Absensi Kelas
    Permission::firstOrCreate(['name' => 'absenkelas.delete', 'guard_name' => 'api']);

    //  View Absensi Kelas
    Permission::firstOrCreate(['name' => 'absenkelas.view', 'guard_name' => 'api']);

    //  Edit Absensi Kelas
    Permission::firstOrCreate(['name' => 'absenkelas.edit', 'guard_name' => 'api']);
